...
class CNNNer(nn.Module):
    ...
    def forward(self, input_ids, bpe_len, indexes, matrix):
        ...
        if hasattr(self, 'cnn'):
            ...
            # wo fusion
            # scores = u_scores + g_scores + scores
            # wo fusion + gsda
            # scores = u_scores + scores
            # wo fusion + lsde
            scores = g_scores + scores
