...
if args.model_name is None:
    if 'genia' in args.dataset_name:
        args.model_name = '/root/autodl-tmp/CNN_Nested_NER 2/data/model/biobert-v1.1'
    elif args.dataset_name in ('ace2004', 'ace2005'):
        args.model_name = '/root/autodl-tmp/CNN_Nested_NER 2/data/model/bert-large-uncased'
    else:
        args.model_name = '/root/autodl-tmp/CNN_Nested_NER 2/data/model/bert-large-uncased'
...
def get_data(dataset_name, model_name):
    ...
    if dataset_name == 'ace2004':
        paths = '/root/autodl-tmp/CNN_Nested_NER 2/preprocess/outputs/ace2004'
    elif dataset_name == 'ace2005':
        paths = '/root/autodl-tmp/CNN_Nested_NER 2/preprocess/outputs/ace2005'
    elif dataset_name == 'genia':
        paths = '/root/autodl-tmp/CNN_Nested_NER 2/preprocess/outputs/genia'
    else:
